...
namespace GraduationProject_API.Controllers
{
	...
	public class AuthsController : ControllerBase
	{
		...
		public async Task<IActionResult> Register([FromBody] RegisterDtos registerDtos)
		{
			...
			if (string.IsNullOrEmpty(user11.Image)) // فقط إذا لم يوفر المستخدم صورة
			{
				user11.Image = user11.Gender == Gender.Male
			...
			var result = await authRepositry.RegisterAsync(user11, registerDtos.Password);
