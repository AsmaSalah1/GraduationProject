...
namespace GraduationProject_Infrastructure.Repositories
{
	public class CommentRepositry : ICommentRepositry
	{
		...
		public async Task<string> DeleteCommentByPostOwner(int commentId, int userId)
		{
			// العثور على التعليق مع التحقق من أن صاحب المنشور هو المستخدم الحالي
			...
			{
				return "Unauthorized: Only the post owner can delete this comment";
			}
